    ...
    <div>
      ...
      <section className="container py-24 md:py-32 space-y-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/ejemplos" className="inline-flex h-11 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">
            Ver Ejemplos
            <svg className="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          </Link>
          <Link href="https://github.com/rotosaurio/sysrot" target="_blank" rel="noopener noreferrer" className="inline-flex h-11 items-center justify-center rounded-md border border-input bg-background px-8 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">
      ...
      <section className="container py-16 md:py-24">
        <div className="mx-auto max-w-[58rem] text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            Crea tu próximo proyecto con SysrotCore y acelera tu desarrollo hasta 10x.
          </p>
